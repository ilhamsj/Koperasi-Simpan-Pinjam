...
ipcRenderer.send('request-management-data-pengambilan');

ipcRenderer.on('response-management-data-pengambilan', function(event, management_data_pengambilan){
    
    selectAllData(management_data_pengambilan);
...
function selectAllData(management_data_pengambilan){
    var html = "";

    management_data_pengambilan.forEach(function(result){
        html += '<tr>';
        html += '<td>';
        ...
        html += '</td>';
        html += '<td>';
        html += stringToDate(result.tgl_pengambilan);
        html += '</td>';
        html += '<td>';
        html += result.jml_pengambilan;
        html += '</td>';
        html += '</tr>';
